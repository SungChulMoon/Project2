...
public class UserInfomation extends JFrame {
	...
	public UserInfomation(UserObject us) {
		...
		lb_id.setFont(new Font("굴림", Font.PLAIN, 17));
		...
		lb_name.setFont(new Font("굴림", Font.PLAIN, 17));
		...
		tf_location.setFont(new Font("굴림", Font.PLAIN, 17));
		...
		ch1.setFont(new Font("굴림", Font.PLAIN, 17));
		...
		ch2.setFont(new Font("굴림", Font.PLAIN, 17));
		...
		ch3 = new JCheckBox("");
		ch3.setFont(new Font("굴림", Font.PLAIN, 17));
		...
		ch4.setFont(new Font("굴림", Font.PLAIN, 17));
