...
public class matchCloth {		
	...
	private void produceClothMatrix() {
		...
		for(int i=0; i<initialFileCloth.clo_outer.size(); i++) {
			int score=0;
			
			if((tempST==tempState.WARM_4 || tempST==tempState.WARM_3||tempST==tempState.WARM_2||tempST==tempState.WARM_1)
					&& initialFileCloth.clo_outer.get(i).weather.equals("WARM")) score+=100;
			else if((tempST==tempState.COLD_1 || tempST==tempState.COLD_2||tempST==tempState.COLD_3||tempST==tempState.COLD_4)
					&& initialFileCloth.clo_outer.get(i).weather.equals("COLD")) score+=100;
			else score-=100;
			
			score+=(initialFileCloth.clo_outer.get(i).body[bd]*10);
			
			score+=(int)(initialFileCloth.clo_outer.get(i).thick*matchCloth.thick_weight+initialFileCloth.clo_outer.get(i).style[style]*matchCloth.style_weight)/10;
			clothMatrix[0][i]=score;
		}
		
		for(int i=0; i<initialFileCloth.clo_top.size(); i++) {
			int score=0;
			
			if((tempST==tempState.WARM_4 || tempST==tempState.WARM_3||tempST==tempState.WARM_2||tempST==tempState.WARM_1)
					&& initialFileCloth.clo_top.get(i).weather.equals("WARM")) score+=100;
			else if((tempST==tempState.COLD_1 || tempST==tempState.COLD_2||tempST==tempState.COLD_3||tempST==tempState.COLD_4) 
					&& initialFileCloth.clo_top.get(i).weather.equals("COLD")) score+=100;
			else score-=100;
			
			score+=(initialFileCloth.clo_top.get(i).body[bd]*10);
			
			score+=(int)(initialFileCloth.clo_top.get(i).thick*matchCloth.thick_weight+initialFileCloth.clo_top.get(i).style[style]*matchCloth.style_weight)/10;
			clothMatrix[1][i]=score;
		}
		
		for(int i=0; i<initialFileCloth.clo_pants.size(); i++) {
			int score=0;
			
			if((tempST==tempState.WARM_4 || tempST==tempState.WARM_3||tempST==tempState.WARM_2||tempST==tempState.WARM_1) 
					&& initialFileCloth.clo_pants.get(i).weather.equals("WARM")) score+=100;
			else if((tempST==tempState.COLD_1 || tempST==tempState.COLD_2||tempST==tempState.COLD_3||tempST==tempState.COLD_4) 
					&& initialFileCloth.clo_pants.get(i).weather.equals("COLD")) score+=100;
			else score-=100;
			
			score+=(initialFileCloth.clo_pants.get(i).body[bd]*10);
			
			score+=(int)(initialFileCloth.clo_pants.get(i).thick*matchCloth.thick_weight+initialFileCloth.clo_pants.get(i).style[style]*matchCloth.style_weight)/10;
			clothMatrix[2][i]=score;
		}
		
		for(int i=0; i<initialFileCloth.clo_shoes.size(); i++) {
			int score=0;
			
			if((tempST==tempState.WARM_4 || tempST==tempState.WARM_3||tempST==tempState.WARM_2||tempST==tempState.WARM_1)
					&& initialFileCloth.clo_shoes.get(i).weather.equals("WARM")) score+=100;
			else if((tempST==tempState.COLD_1 || tempST==tempState.COLD_2||tempST==tempState.COLD_3||tempST==tempState.COLD_4)
					&& initialFileCloth.clo_shoes.get(i).weather.equals("COLD")) score+=100;
			else score-=100;
			
			score+=(initialFileCloth.clo_shoes.get(i).body[bd]*10);
			
			score+=(int)(initialFileCloth.clo_shoes.get(i).thick*matchCloth.thick_weight+initialFileCloth.clo_shoes.get(i).style[style]*matchCloth.style_weight)/10;
